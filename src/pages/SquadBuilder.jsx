    ...
    <div style={{
      ...
      <div style={{ textAlign: 'center' }}>
        ...
        <p style={{ fontSize: 14, color: C.textSecondary, lineHeight: 1.6 }}>
          Upload FM screenshots to build your squad. Extract player stats and export as CSV.
...
export default function SquadBuilder() {
  ...
  return (
    <>
          ...
          {!user && (
            <>
              ...
              <p style={{ fontSize: 16, color: C.textSecondary, maxWidth: 520, margin: '0 auto' }}>
                Upload your FM squad screenshots to build and manage your team. Extract stats and export as CSV.
              </p>
            </>
          )}
          {user && (
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12 }}>
              ...
              <button
                ...
                style={{
                  ...
                  padding: '4px 10px', color: C.textMuted, fontSize: 11,
                  cursor: 'pointer', fontFamily: 'Inter, sans-serif',
                }}
              >
                Logout
      ...
      {/* Content */}
      <Section style={{ paddingTop: user ? 16 : 0, paddingBottom: 48 }}>
        {user ? <StatsScannerTool user={user} /> : <LoginGate onLogin={setUser} />}
      </Section>
    </>
  )
}
